...
export const mockTasks: CrmTask[] = [
  { id: "task_1", title: "Send proposal to Northwind Analytics", status: "IN_PROGRESS", priority: "HIGH", dueDate: "2026-07-22T17:00:00Z", assigneeName: "Dmitry", relatedTo: "Northwind Analytics" },
  { id: "task_2", title: "Follow up on Fjord Studio demo", status: "TODO", priority: "MEDIUM", dueDate: "2026-07-23T12:00:00Z", assigneeName: "Dmitry", relatedTo: "Fjord Studio" },
  { id: "task_3", title: "Prepare Kaido Robotics onboarding checklist", status: "DONE", priority: "MEDIUM", dueDate: "2026-07-19T09:00:00Z", assigneeName: "Priya Shah", relatedTo: "Kaido Robotics" },
  { id: "task_4", title: "Confirm contract terms with legal", status: "TODO", priority: "HIGH", dueDate: "2026-07-25T15:00:00Z", assigneeName: "Priya Shah", relatedTo: "Meridian Health Partners" },
  { id: "task_5", title: "Draft Q3 outreach segment for Retail", status: "TODO", priority: "LOW", dueDate: "2026-07-28T09:00:00Z", assigneeName: "Dmitry" },
];

export const mockMeetings: Meeting[] = [
  { id: "mtg_1", title: "Discovery Call", companyName: "Northwind Analytics", contactName: "Ava Chen", startTime: "2026-07-22T15:00:00Z", endTime: "2026-07-22T15:30:00Z", location: "Google Meet", attendees: ["Dmitry", "Ava Chen"] },
  { id: "mtg_2", title: "Product Demo", companyName: "Fjord Studio", contactName: "Lars Eriksen", startTime: "2026-07-23T10:00:00Z", endTime: "2026-07-23T10:45:00Z", location: "Zoom", attendees: ["Dmitry", "Lars Eriksen"] },
  { id: "mtg_3", title: "Contract Review", companyName: "Meridian Health Partners", contactName: "Sofia Alvarez", startTime: "2026-07-24T13:00:00Z", endTime: "2026-07-24T14:00:00Z", location: "Google Meet", attendees: ["Priya Shah", "Sofia Alvarez"] },
  { id: "mtg_4", title: "Quarterly Business Review", companyName: "Kaido Robotics", contactName: "Yuki Tanaka", startTime: "2026-07-25T09:00:00Z", endTime: "2026-07-25T10:00:00Z", location: "In person — Tokyo office", attendees: ["Dmitry", "Yuki Tanaka"] },
];
