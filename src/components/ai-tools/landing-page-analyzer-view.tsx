    ...
    <div className="grid gap-6 lg:grid-cols-5">
      <Card className="h-fit lg:col-span-2">
        ...
        <CardContent className="space-y-4">
          <Field>
            <FieldLabel htmlFor="url">Page URL</FieldLabel>
            <Input
              id="url"
              placeholder="e.g. copperheadoutfitters.com/spring-sale"
              value={url}
      ...
      <Card className="lg:col-span-3">
        <CardHeader>
          <CardTitle className="text-base">Conversion Report</CardTitle>
        </CardHeader>
        <CardContent>
          <ToolResultPanel
            isLoading={isLoading}
            ...
            emptyDescription="Enter a landing page URL and click Analyze to see conversion signals."
          >
            {result && (
              <>
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between text-sm">
                    <span className="font-medium">Conversion readiness</span>
